...
INSERT INTO `subject_progress` (`student_id`, `subject`, `subject_name`, `full_name`, `status`, `icon`, `training_hours`, `required_hours`, `pass_date`, `score`) VALUES
(1, 1, '科一', '理论知识', 'passed', '📚', 0, 0, '2024-04-10', 96),
(1, 2, '科二', '场地驾驶', 'training', '🚗', 8.5, 16, NULL, NULL),
(1, 3, '科三', '道路驾驶', 'not_started', '🛣️', 0, 16, NULL, NULL),
(1, 4, '科四', '文明驾驶', 'not_started', '🎯', 0, 0, NULL, NULL);
...
('李教练', '👨‍🏫', '男', 42, 12, '大众朗逸', '京A·12345学', 4.9, 328, 56, '95.8%', '耐心细致,通过率高,教学专业', '13912341234', 2, 1),
('王教练', '👩‍🏫', '女', 38, 8, '丰田卡罗拉', '京A·67890学', 4.8, 256, 42, '93.2%', '温柔耐心,讲解清晰,通过率高', '13856785678', 2, 3),
('陈教练', '🧑‍🏫', '男', 45, 15, '大众速腾', '京A·11111学', 4.7, 412, 68, '96.5%', '资深教练,教学严谨,经验丰富', '13790129012', 3, 6),
('刘教练', '👨‍🏫', '男', 36, 6, '雪铁龙爱丽舍', '京A·22222学', 4.6, 178, 35, '91.5%', '年轻活力,教学新颖,善于沟通', '13634563456', 2, 0);
...
INSERT INTO `courses` (`student_id`, `coach_id`, `coach_name`, `coach_avatar`, `course_date`, `time_slot_id`, `time_start`, `time_end`, `location`, `subject`, `hours`, `status`, `message`, `reviewed`) VALUES
(1, 1, '李教练', '👨‍🏫', DATE_ADD(CURDATE(), INTERVAL 1 DAY), 'morning2', '10:00', '12:00', '阳光驾校训练场地A区 - 3号位', 2, 2, 'upcoming', '想练倒库', 0),
(1, 2, '王教练', '👩‍🏫', DATE_ADD(CURDATE(), INTERVAL 2 DAY), 'afternoon1', '14:00', '16:00', '阳光驾校训练场地B区 - 1号位', 2, 2, 'upcoming', '需要加强坡道起步', 0),
(1, 1, '李教练', '👨‍🏫', DATE_ADD(CURDATE(), INTERVAL 4 DAY), 'morning1', '08:00', '10:00', '阳光驾校训练场地A区 - 3号位', 2, 2, 'upcoming', '', 0),
(1, 1, '李教练', '👨‍🏫', DATE_SUB(CURDATE(), INTERVAL 3 DAY), 'afternoon2', '16:00', '18:00', '阳光驾校训练场地A区 - 3号位', 2, 2, 'completed', '综合训练为主', 1),
(1, 2, '王教练', '👩‍🏫', DATE_SUB(CURDATE(), INTERVAL 5 DAY), 'morning2', '10:00', '12:00', '阳光驾校训练场地B区 - 1号位', 2, 2, 'completed', '多练侧方停车', 0);
